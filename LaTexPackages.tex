...
\usepackage[ruled,vlined]{algorithm2e} % to write algorithm and pseudocode 
\usepackage{multirow}
\usepackage{xcolor}
\usepackage{color, colortbl}
% \usepackage[table]{xcolor}
\definecolor{mygreen}{RGB}{122 ,219,48}
% \usepackage{bbding} % to write checkmark for the table
% \usepackage{newfloat}
